 ...
 * @description Página de ejemplo para probar la integración de Sentry en la aplicación.
 *              Este Client Component simula errores tanto en el frontend como en el backend
 *              (a través de una llamada a API) para verificar que Sentry los captura
 ...
 * @see src/app/api/sentry-example-api/route.ts (API endpoint de ejemplo)
 */
"use client";
 ...
 * @description Clase de error personalizada para identificar errores específicos
 *              del frontend en la página de ejemplo de Sentry.
 * @extends Error
 */
 ...
 * @description Página de UI de cliente que contiene botones para simular
 *              errores en el frontend y en el backend (vía API). Muestra
 *              el estado de conectividad con Sentry.
...
export default function Page(): React.ReactElement {
  ...
  // Efecto para diagnosticar la conectividad del SDK de Sentry en el cliente.
  useEffect(() => {
    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            href="https://metashark-tech.sentry.io/issues/?project=4509967264776272"
          >
            Issues Page
          </a>

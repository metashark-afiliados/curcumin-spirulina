...
const FormInput = React.forwardRef<HTMLInputElement, FormInputProps>(
  ({ id, label, icon: Icon, error, className, ...props }, ref) => {
    ...
    const gradientVariants: Variants = {
      default: { background: "linear-gradient(90deg, #4B5563, #6B7280)" },
      focused: { background: "linear-gradient(90deg, #F97316, #FBBF24)" },
      error: { background: "linear-gradient(90deg, #DC2626, #EF4444)" },
    };
